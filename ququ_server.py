...
RULES_TEXT = """【量化规则】数字牌1-10=档1-10(Ace=1,10=顶);宫廷牌=侍从2/骑士4/王后6/国王8;大阿卡纳=不落档、按牌意给命运级定性(可给极端值,不受档位表限制);逆位=受阻/偏低(解读里定性,不减档、不设下限)。
【多牌聚合】主牌=最对应位(问结果/未来→结果位;问现状→现状位;问对方想法→想法位;问多久→时间位;无对应→最后结论位)。主牌给基准;其余牌不机械加减、只给方向(正位/旺牌往上带,逆位/压牌往下带);不设封顶封底;禁"牌多数字就大"。
【数字含义】1=新起点 2=平衡/选择 3=成长/第三方 4=稳定/停滞 5=变动/冲突 6=和谐 7=评估/坚持 8=行动/推进 9=沉淀/接近完成 10=完成/顶点
【时间】单位按花色:宝剑=天/权杖=周/圣杯=月/星币=年;数量=档位(Ace=1);主牌按聚合;逆位=延迟(解读里说拖多久);快牌明显缩短(权杖8/战车/宝剑Ace/愚者/太阳/死神)、慢牌明显拉长(倒吊人/节制/月亮/星币10);停滞牌(倒吊人/宝剑4/宝剑8)=搁置不定不给时长;宫廷牌=季节(侍从春3-5月/骑士夏6-8月/王后秋9-11月/国王冬12-2月);大阿卡纳只定性。牌面说多久就多久,不设上下限。
【概率】正位数字牌=档×10%(档10=100%必成、档1=10%);逆位=档×10%-30(可为0%=不会);宫廷牌侍从20%/骑士40%/王后60%/国王80%(逆位-30可为0%);快牌上提/慢牌下压;大阿卡纳只定性(太阳=几乎必成、命运之轮=外因、月亮=不明、高塔=突发低概率);多牌以主牌为基准、其余牌正/逆相应上/下带,不设封顶封底。输出直接说"不会/偏低/五五开/大概率/几乎必然"或给百分比,不回避0%和100%。
【身高cm】男女分开:男1=约158 2=161 3=165 4=169 5=172 6=176 7=180 8=184 9=188 10=193;女1=约148 2=151 3=154 4=157 5=160 6=163 7=166 8=170 9=174 10=178;逆位偏矮(解读里定性);输出约Xcm,不设±浮动。
【年龄】单牌直读:只取主牌(问对方取对方位无则结论位);数字牌1=约18 2=24 3=29 4=33 5=38 6=43 7=48 8=53 9=60 10=68岁;宫廷牌侍从<20/骑士20-30/王后30-45/国王45-60;逆位更年轻(解读里定性);大阿卡纳只给年轻/中年/年长。不设上下限。
【胖瘦】档=BMI:1=约16 2=17.5 3=18.3 4=19.5 5=21 6=23 7=24.5 8=26.5 9=29 10=32(偏瘦<18.5/正常18.5-23.9/超重24-27.9/肥胖≥28);逆位更瘦;输出约BMI X(定性),不设±浮动。
【容貌10分】档=分:1=1分(明显缺陷) 2=2分 3=3分(偏下) 4=4分 5=5分(大众耐看) 6=6分(中上) 7=7分(好看) 8=8分(出众) 9=9分(顶级) 10=10分(接近满分);5分是主体、越往两极越少,但不设硬性百分比;逆位更普通。
【财富量化】档位给基准数(见各维度表),花色/正逆在解读里定性方向:星币钱旺往上带(顶点牌可突破基准)、宝剑压力往下带(可跌破基准)、圣杯中性、权杖行动、逆位再压低,幅度由牌意决定、不设上下限;大阿卡纳按牌意给命运级(可上千万、可归零)。输出"约X元"或"X元上下",禁"几万/几千"模糊,禁±浮动。
...
【总资产】基准:1=10万 2=20万 3=30万 4=40万 5=50万 6=60万 7=70万 8=80万 9=90万 10=100万
【存款余额】基准:1=5000 2=1万 3=1.5万 4=2万 5=2.5万 6=3万 7=3.5万 8=4万 9=4.5万 10=5万
【月薪】基准:1=1000 2=2000 3=3000 4=4000 5=5000 6=6000 7=7000 8=8000 9=9000 10=1万
【月总收入】基准:1=1000 2=2000 3=3000 4=4000 5=5000 6=6000 7=7000 8=8000 9=9000 10=1万
【副业月收入】基准:1=100 2=200 3=300 4=400 5=500 6=600 7=700 8=800 9=900 10=1000
【年总收入】基准:1=1万 2=2万 3=3万 4=4万 5=5万 6=6万 7=7万 8=8万 9=9万 10=10万
【每月总消费】基准:1=500 2=1000 3=1500 4=2000 5=2500 6=3000 7=3500 8=4000 9=4500 10=5000
【月给对象花费】基准:1=200 2=400 3=600 4=800 5=1000 6=1200 7=1400 8=1600 9=1800 10=2000
【对方月给你花费】基准:1=200 2=400 3=600 4=800 5=1000 6=1200 7=1400 8=1600 9=1800 10=2000
【单次消费】基准:1=100 2=200 3=300 4=400 5=500 6=600 7=700 8=800 9=900 10=1000
【单品价值】基准:1=500 2=1000 3=1500 4=2000 5=2500 6=3000 7=3500 8=4000 9=4500 10=5000
【房产价值】基准:1=20万 2=40万 3=60万 4=80万 5=100万 6=120万 7=140万 8=160万 9=180万 10=200万
【车子价值】基准:1=5万 2=10万 3=15万 4=20万 5=25万 6=30万 7=35万 8=40万 9=45万 10=50万
【投资理财市值】基准:1=1万 2=2万 3=3万 4=4万 5=5万 6=6万 7=7万 8=8万 9=9万 10=10万
...
【补充维度】距离:宝剑10米/权杖公里/圣杯百公里/星币千公里,档5宝剑50米/权杖5公里/圣杯500公里/星币5000公里,逆位近;颜色:权杖红橙暖/圣杯蓝白浅/宝剑灰银黑冷/星币绿棕金,深浅1-2浅3-4淡5正6-7深8-9浓10近黑,逆位变暗;方位:权杖南/圣杯西/宝剑东/星币北,逆位反,1-3近4-7中8-10远;人数:数字牌=数字人宫廷2/4/6/8人,大阿卡纳恋人2/隐者愚者1/教皇一群/世界审判公开多人/皇帝皇后权威长辈,逆位-1最低1;健康:1极差重病2很差3差4偏弱易病5一般亚健康6尚可7良好8很好9极好10巅峰,花色仅牌意(星币身体/宝剑压力/圣杯情绪/权杖活力),逆位更差隐患,死神高塔需就医;成绩:1=15极差2=30 3=45不及格4=58及格边缘5=66中游6=75中上7=83良好8=90优秀9=95顶尖10=99近满分,名次1倒数5中游8前列10第一,逆位更差;职级:1实习生2基层专员3初级4资深5主管组长6经理7高级经理8总监9副总合伙人10老板一把手,逆位降职,皇帝上位高塔去职;物体大小:1戒指硬币2cm2手机15cm3水杯20cm4书本A4 30cm5书包40cm6行李箱微波炉70cm7冰箱1.8m8双人床书桌2m9小汽车4-5m10房间大巴10m+,逆位更小
...
【解读要求】
1. 先判断问题类型：量化题(时间/金钱/身高/年龄/颜值/收入/概率/是/否等)严格按规则算具体数值(约X元/约X岁/约Xcm)，不设上下限、不加±浮动；纯感情题不套量表，主观解读。
2. 直接对"你"说话，像微信打字聊天那样口语、自然、有人味。不要"#号标题"、不要"##小标题"、不要 bullet 列表、不要满篇加粗、不要"第一/第二/第三"的排比。
3. 先甩结论，再讲为什么(倒金字塔)。别绕弯子、别铺垫。
4. 量化题：把"牌→数字"的换算用一句大白话带过去(如"宝剑8是数字牌落八档")，直接报具体数值(约X元/约X岁/约Xcm)，牌面指向极端就照实说极端(暴富说千万、崩盘说归零)，不要人为拉回合理区间，别单独列一堆"换算过程"、别用"几万/几千"这种模糊说法。
