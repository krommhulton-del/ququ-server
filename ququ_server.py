...
【财富·对数尺】(身家/家底/净资产/总资产/家里有多少钱 统一这一套尺,不再另开"富豪尺")档=:1=0或负债 2=5万 3=15万 4=45万 5=140万 6=400万 7=1200万 8=3500万 9=1亿 10=3亿+;锚点:央行城镇家庭净资产中位数141万≈档5。正位照读、逆位档-1。问"总资产"数字同此尺,解读点一句"总资产含房产、通常略高于净资产"即可,不另开高档尺。大阿卡纳在财富题=命运级、不落档:太阳/世界/皇后/皇帝/命运之轮=极富(亿级往上、可达百亿级),高塔/死神/恶魔/月亮=破财/负债/崩盘(可归零),倒吊人/隐者=资金不流动;只给量级、不定死数字。百亿/千亿只由大阿卡纳命运级或明确"上市公司/百亿富豪"语境表达,数字牌最多表达到3亿+。
...
【解读要求】
1. 先判断问题类型：金钱题——收入类【收入·牌面直读】,身家/家底/净资产/总资产统一【财富·对数尺】;时间题按花色单位;是/否按正逆牌义；纯感情题不套量表，主观解读。
