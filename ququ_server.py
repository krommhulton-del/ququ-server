...
RULES_TEXT = """【量化规则·档位制】数字牌1-10=档1-10(Ace=1,10=顶);宫廷牌=侍从2/骑士4/王后6/国王8;大阿卡纳=不落档只定性;逆位=-1档(最低1)。
【多牌聚合】主牌=最对应位:问结果/未来→结果位;问现状→现状位;问对方想法→想法位;问多久→时间位;无对应→最后结论位。主牌落档(数字牌=数字档、宫廷=侍从2/骑士4/王后6/国王8);主牌逆位=-1(最低1);大阿卡纳主牌不落档只定性。其余牌仅修正:正+1/逆-1求和封顶±2。最终=主牌档±修正。禁"牌多数字越大"。输出"约X(浮动±10~15%)"。
【数字含义】1=新起点 2=平衡/选择 3=成长/第三方 4=稳定/停滞 5=变动/冲突 6=和谐 7=评估/坚持 8=行动/推进 9=沉淀/接近完成 10=完成/顶点
【时间】单位按花色:宝剑=天/权杖=周/圣杯=月/星币=年;数量=档位(Ace=1);主牌按聚合;主牌逆位=延迟×2不减档;快牌÷2(权杖8/战车/宝剑Ace/愚者/太阳/死神)、慢牌×2(倒吊人/节制/月亮/星币10)仅数字牌;停滞(倒吊人/宝剑4/宝剑8)不定;宫廷=季节(侍从春3-5月/骑士夏6-8月/王后秋9-11月/国王冬12-2月);大阿卡纳只定性;1张约X多张区间最可能≈主牌档;÷2不足1天=当天
【概率】封顶95%封底5%禁100/0%;正位数字牌=档×10%(10=95%);逆位=档×10%-30封底5%;宫廷侍从20%/骑士40%/王后60%/国王80%(逆-30封底5%);快牌+10%/慢牌-10%(封顶95/5);大阿卡纳只定性(太阳高/月亮模糊/高塔低);多牌主牌定基准其余正+10%/逆-10%封顶±20;输出配几乎不会/几乎必然
【身高cm】男女分开按聚合:男1=158 2=161 3=165 4=169 5=172(中位) 6=176 7=180 8=184 9=188 10=193;女1=148 2=151 3=154 4=157 5=160(中位) 6=163 7=166 8=170 9=174 10=178;男女差12cm;各档±2~3cm输出约Xcm;逆位更矮
【年龄】单牌直读:禁多牌叠加/禁花色加减/禁取最大,只取主牌(问对方取对方位无则结论位)直读;逆位=-1(最低1更年轻);宫廷=侍从<20/骑士20-30/王后30-45/国王45-60;大阿卡纳只给年轻/中年/年长;锚点1=18 2=24 3=29 4=33 5=38 6=43 7=48 8=53 9=60 10=68岁(±2~4输出约X岁)
【胖瘦】档=BMI(中国:<18.5偏瘦/18.5~23.9正常/24~27.9超重/≥28肥胖):1=16重瘦 2=17.5偏瘦 3=18.3偏瘦 4=19.5苗条 5=21中位 6=23正常偏丰 7=24.5超重边缘 8=26.5超重 9=29肥胖 10=32重肥胖;±0.5~1输出约BMI X(偏瘦/正常/超重/肥胖);逆位更瘦
【容貌10分】档=分钟形(5分≈40%主体两极递减8分极少):1=1分缺陷 2=2分(2%) 3=3分(6%) 4=4分(15%) 5=5分(大众40%) 6=6分(中上25%) 7=7分(好看10%) 8=8分(明星3%) 9=9分(顶级0.5%) 10=10分(理论顶点改述接近满分);男看骨相/肩宽/气质、女看五官/身材/气质;逆位更普通
【财富量化·细化】结果=档位×固定单位×花色系数×正逆系数×修正系数(封顶),算具体零头不凑整;财富题逆位不减档、不用±档修正,只用系数累乘;大阿卡纳主牌不落档只定性;输出"约X元(浮动±10~15%)"。花色系数(牌面本义非人均收入):星币×1.12(钱旺)/权杖×1.06(行动)/圣杯×0.994(中性)/宝剑×0.94(压力);正逆系数:正位×1.00/逆位×0.88(受阻);修正系数:多牌时其余牌正位×1.05/逆位×0.95、最多计2张封顶×1.10~×0.90。例:月薪档5星币5正=5×1000×1.12×1.00=5600元;宝剑5逆=5×1000×0.94×0.88≈4136元;圣杯5正=5×1000×0.994×1.00=4970元。
【财富识别】总资产=家里多少钱/家底;存款余额=存款/余额/攒了;月薪=工资/到手/底薪;月总收入=全收入/加副业;副业月收入=副业/兼职/外快;年总收入=一年赚/年薪;每月总消费=每月花/开销/生活费;月给对象花费=给对象/伴侣/TA花;对方月给你花费=对象/伴侣给你花;单次消费=约会/礼物/一次;单品价值=包/首饰/手表/手机值;房产价值=房/房价;车子价值=车值;投资理财市值=股票/基金/理财。别混月薪与总资产拿不准追问。
【总资产】单位10万:1=10万 2=20万 3=30万 4=40万 5=50万 6=60万 7=70万 8=80万 9=90万 10=100万
【存款余额】单位5000:1=5000 2=1万 3=1.5万 4=2万 5=2.5万 6=3万 7=3.5万 8=4万 9=4.5万 10=5万
【月薪】单位1000:1=1000 2=2000 3=3000 4=4000 5=5000 6=6000 7=7000 8=8000 9=9000 10=1万
【月总收入】单位1000:1=1000 2=2000 3=3000 4=4000 5=5000 6=6000 7=7000 8=8000 9=9000 10=1万
【副业月收入】单位100:1=100 2=200 3=300 4=400 5=500 6=600 7=700 8=800 9=900 10=1000
【年总收入】单位1万:1=1万 2=2万 3=3万 4=4万 5=5万 6=6万 7=7万 8=8万 9=9万 10=10万
【每月总消费】单位500:1=500 2=1000 3=1500 4=2000 5=2500 6=3000 7=3500 8=4000 9=4500 10=5000
【月给对象花费】单位200:1=200 2=400 3=600 4=800 5=1000 6=1200 7=1400 8=1600 9=1800 10=2000
【对方月给你花费】单位200:1=200 2=400 3=600 4=800 5=1000 6=1200 7=1400 8=1600 9=1800 10=2000
【单次消费】单位100:1=100 2=200 3=300 4=400 5=500 6=600 7=700 8=800 9=900 10=1000
【单品价值】单位500:1=500 2=1000 3=1500 4=2000 5=2500 6=3000 7=3500 8=4000 9=4500 10=5000
【房产价值】单位20万:1=20万 2=40万 3=60万 4=80万 5=100万 6=120万 7=140万 8=160万 9=180万 10=200万
【车子价值】单位5万:1=5万 2=10万 3=15万 4=20万 5=25万 6=30万 7=35万 8=40万 9=45万 10=50万
【投资理财市值】单位1万:1=1万 2=2万 3=3万 4=4万 5=5万 6=6万 7=7万 8=8万 9=9万 10=10万
【是/否】独立计分:每牌投票(正=是+1/逆=否+1/大阿卡纳+2:太阳/世界/星星/恋人偏是、高塔/死神/恶魔/月亮偏否、倒吊人/节制不投);是>否=是、否>是=否、相等=待定补1张;结论位大阿卡纳优先;单张正偏是/逆偏否(把握低);输出是/否/待定+把握(勉强/倾向/明确/斩钉截铁)
【补充维度】距离:宝剑10米/权杖公里/圣杯百公里/星币千公里,档5宝剑50米/权杖5公里/圣杯500公里/星币5000公里,逆位近;颜色:权杖红橙暖/圣杯蓝白浅/宝剑灰银黑冷/星币绿棕金,深浅1-2浅3-4淡5正6-7深8-9浓10近黑,逆位变暗;方位:权杖南/圣杯西/宝剑东/星币北,逆位反,1-3近(百米)4-7中(公里)8-10远(十公里);人数:数字牌=数字人(Ace1…10=10人)宫廷2/4/6/8人,大阿卡纳恋人2/隐者愚者1/教皇一群/世界审判公开多人/皇帝皇后权威长辈,逆位-1最低1;健康:1极差重病2很差3差4偏弱易病5一般亚健康6尚可7良好8很好9极好10巅峰,花色仅牌意(星币身体/宝剑压力/圣杯情绪/权杖活力),逆位更差隐患,死神高塔需就医;成绩:1=15极差2=30 3=45不及格4=58及格边缘5=66中游6=75中上7=83良好8=90优秀9=95顶尖10=99近满分,名次1倒数5中游8前列10第一,逆位更差;职级:1实习生2基层专员3初级4资深5主管组长6经理7高级经理8总监9副总合伙人10老板一把手,逆位降职,皇帝上位高塔去职;物体大小:1戒指硬币2cm2手机15cm3水杯20cm4书本A4 30cm5书包40cm6行李箱微波炉70cm7冰箱1.8m8双人床书桌2m9小汽车4-5m10房间大巴10m+,逆位更小
